  ...
  <div v-if="component">
    ...
    >
      ...
      <table class="table table-secondary">
        ...
        <tbody>
          <template
            v-for="(connection, connectionIndex) in connectionGroup.connections"
          >
    ...
    <div
      v-if="component.openApiSpecs && component.openApiSpecs.length > 0"
      class="my-4"
    >
      <h5 class="text-info">OpenAPI Specs</h5>
