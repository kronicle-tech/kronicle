<template>
  <div class="my-3">
    ...
    <b-button v-if="componentAvailableData.hasNodes" class="my-1" :to="`/components/${componentId}/dependencies`">
      Visualizations
    </b-button>
    <b-button v-if="componentAvailableData.hasNodes" class="my-1" :to="`/components/${componentId}/response-times`">
      Response Times
    </b-button>
    <b-button v-if="componentAvailableData.hasNodes" class="my-1" :to="`/components/${componentId}/downstream-response-times`">
      Downstream Response Times
    </b-button>
    <b-button v-if="componentAvailableData.hasCallGraphs" class="my-1" :to="`/components/${componentId}/call-graphs`">
      Call Graphs
    </b-button>
    <b-button v-if="hasMetadataType('cross-functional-requirement')" class="my-1" :to="`/components/${componentId}/cross-functional-requirements`">
      Cross Functional Requirements
    </b-button>
    <b-button v-if="hasMetadataType('tech-debt')" class="my-1" :to="`/components/${componentId}/tech-debts`">
      Tech Debts
    </b-button>
    <b-button v-if="hasMetadataType('scanner-error')" class="my-1" :to="`/components/${componentId}/errors`">Errors</b-button>
    ...
    <b-button v-if="hasMetadataType('test-result')" class="my-1" :to="`/components/${componentId}/tests`">Tests</b-button>
  </div>
</template>
