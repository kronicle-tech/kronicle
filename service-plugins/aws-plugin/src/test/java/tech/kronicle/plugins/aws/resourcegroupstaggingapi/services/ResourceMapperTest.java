...
public class ResourceMapperTest {
    ...
    public void mapResourcesShouldReturnAnEmptyListWhenResourceListIsEmpty(Boolean apiResourcesWithSupportedMetadataOnly) {
        // Given
        ResourceMapper underTest = createUnderTest();

        // When
        List<Component> returnValue = underTest.mapResourcesToComponents(createProfile(apiResourcesWithSupportedMetadataOnly), List.of());
    ...
    @ParameterizedTest
    @MethodSource("provideMappingConfigAndDoNotIgnoreComponentsWithoutSupportedMetadata")
    public void mapResourcesShouldMapAllResourcesToComponentsAndConnections(MappingConfig mappingConfig, Boolean apiResourcesWithSupportedMetadataOnly) {
        // Given
        ...
        // When
        List<Component> returnValue = underTest.mapResourcesToComponents(createProfile(apiResourcesWithSupportedMetadataOnly), resources);
    ...
    public void mapResourcesShouldIgnoreResourcesWithoutSupportedMetadataWhenProfileIsConfiguredToIgnoreThem(MappingConfig mappingConfig) {
        // Given
        ResourceMapper underTest = createUnderTest(mappingConfig);
        List<ResourceGroupsTaggingApiResource> resources = List.of(
                new ResourceGroupsTaggingApiResource(
        ...
        // When
        List<Component> returnValue = underTest.mapResourcesToComponents(createProfile(true), resources);
    ...
    private static Stream<Arguments> provideMappingConfigAndDoNotIgnoreComponentsWithoutSupportedMetadata() {
        return provideMappingConfig()
                .flatMap(mappingConfig -> Stream.of(
                        arguments(mappingConfig, null),
                        arguments(mappingConfig, false)
                ));
    }

    private static Stream<MappingConfig> provideMappingConfig() {
        return Stream.of(
    ...
    private AwsProfileConfig createProfile(Boolean apiResourcesWithSupportedMetadataOnly) {
