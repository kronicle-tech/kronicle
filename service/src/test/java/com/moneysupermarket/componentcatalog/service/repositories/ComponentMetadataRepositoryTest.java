...
import com.moneysupermarket.componentcatalog.service.services.GitCloner;
import com.moneysupermarket.componentcatalog.service.services.RepoProviderFinder;
...
public class ComponentMetadataRepositoryTest extends BaseTest {
    ...
    private final ValidatorService validatorService = createValidationService();
    ...
    public void getComponentMetadataShouldSkipARepoIfItDoesNotAContainComponentMetadata() throws IOException, GitAPIException, URISyntaxException {
        ...
        assertThat(event.getThrowableProxy().getMessage()).endsWith(
                "service/src/test/resources/com/moneysupermarket/componentcatalog/service/repositories/ComponentMetadataRepositoryTest/RepoWithNoComponentMetadata/component-metadata.yaml");
    ...
    public void getComponentMetadataShouldSkipARepoIfItContainsInvalidYaml() throws IOException, GitAPIException, URISyntaxException {
        ...
        assertThat(event.getThrowableProxy().getMessage()).isEqualTo(""
                ...
                + "    ^\n"
                + "\n"
                + " at [Source: (StringReader); line: 2, column: 14] (through reference chain: com.moneysupermarket.componentcatalog.componentmetadata.models.ComponentMetadata$ComponentMetadataBuilder[\"components\"])");
    ...
    public void getComponentMetadataShouldSkipARepoIfValidationFailsForItsComponentMetadata() throws IOException, GitAPIException, URISyntaxException {
        ...
        event = events.get(0);
        assertThat(event.getFormattedMessage()).isEqualTo("Could not read Component Metadata file from repo \"https://example.com/repo-2.git\"");
        assertThat(event.getThrowableProxy().getClassName()).isEqualTo("com.moneysupermarket.componentcatalog.service.exceptions.ValidationException");
        assertThat(event.getThrowableProxy().getMessage()).isEqualTo(""
                + "Failed to validate com.moneysupermarket.componentcatalog.componentmetadata.models.ComponentMetadata with reference \"component-metadata\". Violations:\n"
