...
import com.moneysupermarket.componentcatalog.service.repositories.ComponentRepository;
...
public class ComponentServiceTest {
    ...
    public void getTestsShouldReturnAllTests() {
        // Given
        com.moneysupermarket.componentcatalog.sdk.models.Test test1 = com.moneysupermarket.componentcatalog.sdk.models.Test.builder()
                .id("test-test-id-1")
                .build();
        com.moneysupermarket.componentcatalog.sdk.models.Test test2 = com.moneysupermarket.componentcatalog.sdk.models.Test.builder()
                .id("test-test-id-2")
                .build();
        List<com.moneysupermarket.componentcatalog.sdk.models.Test> tests = List.of(test1, test2);
    ...
    public void getTestShouldReturnTheTestWithMatchingId() {
        ...
        // When
        com.moneysupermarket.componentcatalog.sdk.models.Test returnValue = underTest.getTest(test1.getId());
