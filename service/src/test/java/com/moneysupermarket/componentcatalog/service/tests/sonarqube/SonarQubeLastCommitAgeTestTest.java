    ...
    public void testShouldReturnFailWhenComponentHasASonarQubeProjectWithLastCommitAgeThatIsHigherThanMaximum() {
        ...
        assertThat(returnValue).isEqualTo(
                TestResult.builder()
                        ...
                        .outcome(TestOutcome.FAIL)
                        .priority(Priority.HIGH)
                        .message("At least one of the component's SonarQube project(s) have not been updated with the results of at least 1 commit in the last 7 months. Is the component's build job still configured to send metrics to the SonarQube server? If not, the project(s) metrics in the Component Catalog will be out-of-date. \n"
                                + "\n"
