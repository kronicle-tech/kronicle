...
import tech.kronicle.service.scanners.zipkin.services.DependencyDurationCalculator;
import tech.kronicle.service.scanners.zipkin.services.DependencyHelper;
import tech.kronicle.service.scanners.zipkin.services.GenericDependencyCollator;
...
public class ZipkinScannerTest extends BaseScannerTest {
    ...
    private void createZipkinScanner(boolean zipkinEnabled) {
        ...
        ZipkinConfig config = new ZipkinConfig(zipkinEnabled, zipkinBaseUrl, Duration.ofMinutes(2), null, null, 100, null);
